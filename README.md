...
1. 启动 FH6，并保持窗口模式或无边框窗口模式，不要最小化；游戏客户区不得低于 `1600×900`。
2. 打开 `FH6Gacha.exe`。
...
环境：Windows 10/11、Python 3.10+、FH6 简体中文、Steam 版，游戏客户区至少 `1600×900`。
...
- [ ] `1600×900` 窗口/无边框下，游戏在后台时能识别普通和超级抽奖入口。
- [ ] 1080p 或更高窗口下，普通和超级抽奖入口缩放识别正常。
